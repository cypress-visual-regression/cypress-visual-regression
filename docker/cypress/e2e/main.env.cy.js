  ...
  () => {
    it("take screenshot with parent command", () => {
      if (Cypress.env("type") === "base") {
        ...
        cy.task(
          "doesExist",
          "./cypress/snapshots/base/main.env.cy.js/home.png"
        ).should("be.true");
        cy.task(
          "doesExist",
          "./cypress/snapshots/diff/main.env.cy.js/home.png"
        ).should("be.true");
        cy.task(
          "doesExist",
          "./cypress/snapshots/actual/main.env.cy.js/home.png"
        ).should("be.true");
      }
    });
    ...
    it("take screenshot with child command", () => {
      if (Cypress.env("type") === "base") {
        ...
        cy.task(
          "doesExist",
          "./cypress/snapshots/base/main.env.cy.js/home-child.png"
        ).should("be.true");
        cy.task(
          "doesExist",
          "./cypress/snapshots/diff/main.env.cy.js/home-child.png"
        ).should("be.true");
        cy.task(
          "doesExist",
          "./cypress/snapshots/actual/main.env.cy.js/home-child.png"
        ).should("be.true");
      }
    });
  }
