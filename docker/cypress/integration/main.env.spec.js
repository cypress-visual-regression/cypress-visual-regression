describe('Visual Regression Example with setting paths by environment variables', {
    ...
    it('take screenshot with parent command', () => {
        if (Cypress.env('type') === 'base') {
            ...
            cy.task("doesExist", "./cypress/screenshots/main.env.spec.js/home-actual.png").should("be.true");
        }
    });
    ...
    it('take screenshot with child command', () => {
        if (Cypress.env('type') === 'base') {
            ...
            cy.task("doesExist", "./cypress/screenshots/main.env.spec.js/home-child-actual.png").should("be.true");
        }
    });
  });
